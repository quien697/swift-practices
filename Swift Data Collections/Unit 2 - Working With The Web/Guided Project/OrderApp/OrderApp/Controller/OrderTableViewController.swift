...
class OrderTableViewController: UITableViewController {
  ...
  override func viewDidDisappear(_ animated: Bool) {
    ...
    // Cencel image fetching tasks that are no longer needed
  ...
  func uploadOrder() {
    ...
    Task {
      do {
        ...
        displayError(error, title: "Order Submisson Failed")
      }
    }
  }
  ...
  @IBAction func unwindToOrderList(seque: UIStoryboardSegue) {
    if seque.identifier == "dismissConfirmation" {
