...
// -> It will get error if the type of userAge is Int
// -> Error msg: Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
/*:
 ...
 */
print(userAge) // -> userAge will be nil, if userInputage could not convert to Int
/*:
 ...
 */
print(userAge!) // -> it won't get crash if userAge is Int
/*:
